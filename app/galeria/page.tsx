  ...
  return (
    <section className="w-full bg-[#140309] px-4 pb-24 sm:px-6 sm:pb-16 lg:px-8">
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div
          aria-hidden="true"
          className="linea-ruta mt-5 h-1 w-44 rounded-full bg-gradient-to-r from-[#f7771c] via-[#ee374b] to-[#c51850]"
        />
          ...
          {FOTOS.map((f) => {
            ...
            return (
              <a
                ...
                className={`group relative block overflow-hidden rounded-[14px] border border-white/10 bg-black outline-none focus-visible:ring-2 focus-visible:ring-[#f7771c] ${
              ...
              >
                ...
                <span className="pointer-events-none absolute inset-x-0 bottom-0 hidden bg-gradient-to-t from-black/80 to-transparent px-4 pt-8 pb-3 text-left opacity-0 transition-opacity duration-200 group-hover:opacity-100 lg:block">
                  <span className="font-barlow text-xs font-bold tracking-[0.1em] text-white/90 uppercase">
                    Ver en grande
                  </span>
                </span>
              </a>
        ...
        <div className="mt-14 flex flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] px-6 py-10 text-center">
