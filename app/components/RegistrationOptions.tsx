  ...
  return (
    ...
    >
      <div className="grid w-full max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 md:gap-8">
        ...
        ================================= */}
        <article className="group relative flex flex-col justify-between overflow-hidden rounded-[32px] border border-gray-100 bg-white px-6 py-10 text-gray-900 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_20px_60px_-15px_rgba(247,119,28,0.18)] sm:px-10 sm:py-12">
          {/* Fondo decorativo */}
          <div className="absolute top-0 right-0 h-64 w-64 translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-[#f7771c]/5 to-transparent blur-3xl" />

          <div className="relative z-10">
            <div className="mb-4 flex items-center gap-2">
              <div className="rounded-full bg-gray-100 p-2 text-[#f7771c]">
                <Globe size={20} />
              </div>
          ...
          <div className="relative z-10 mt-10">
            ...
            <Link
              href="/inscripcion"
              className="flex h-14 w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#f7771c] to-[#c51850] text-sm font-bold tracking-[0.15em] text-white uppercase shadow-lg shadow-[#f7771c]/30 transition-all duration-300 hover:-translate-y-1 hover:gap-4 hover:shadow-[#f7771c]/50"
            >
